        ...
        function computerPlay() {
            ...
            switch (computerChoice) {   //Compare computer choice to possible values
        ...
        function playRound(playerSelection) {    //Takes user choice
            console.log(playerSelection);
            computerPlay();
            if (playerSelection === 'rock') displayResultsIfRock(playerSelection, computerChoice);
            else if (playerSelection === 'paper') displayResultsIfPaper(playerSelection, computerChoice);
        ...
        function displayScoresAndRounds() {
            ...
            if (userScore === 5 || computerScore === 5) resetScoresAndRounds();
        }
